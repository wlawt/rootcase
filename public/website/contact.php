...
<html lang="en">
  ...
  <body>
    ...
    <!--Landing page-->
    <div class="jumbotron fade bg-light">
        <div class="h-100 row justify-content-center">
            <div class="col-md-6 text-center">
                <h2 class="display-3 mt-3 pt-5"><span id="header-animation"></span></h2>
                <p class="lead">We would love to hear back from the community!</p>
            </div>
        </div>
      </div>
    ...
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <form action="?" method="POST">
                <div class="g-recaptcha" data-sitekey="6LdL2ZEUAAAAAFBg_ZAio2_towHIJ83rBLRxQbNp"></div>
                <br/>
