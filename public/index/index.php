            ...
            <div class="card">
                <div class="media">
                    ...
                    <div class="media-right">
                        <img class="picture" src="/wp-content/themes/rootcase/Pictures/recycle.png">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="media">
                    <div class="media-left">
                        <img id="leftImg" class="picture" src="/wp-content/themes/rootcase/Pictures/ecofriendly.png">
                    </div>
                    <div class="media-body">
        ...
        <div id="info1" class="hideElement">
            <div class="card">
                <div class="media">
                    ...
                    <div class="media-right">
                        <img class="picture" src="/wp-content/themes/rootcase/Pictures/charity.png"> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="contact" class="text-center fade-right">
        <div class="d-flex justify-content-between">
            ...
            <div class="p-1">
                ...
                <a href="/wp-content/themes/rootcase/index/contact/contact.php">
